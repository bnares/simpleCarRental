    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentedDatas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RentedDatas_CarShops_CarShopId",
                        column: x => x.CarShopId,
                        principalTable: "CarShops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RentedDatas_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentedDatas_CarId",
                table: "RentedDatas",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_RentedDatas_CarShopId",
                table: "RentedDatas",
                column: "CarShopId");
        }
